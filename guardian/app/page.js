            ...
            >
                <div className="flex justify-between items-center w-full">
                    <div className="flex items-center">
                        <Link
                            href="/"
                            className="btn btn-ghost normal-case text-lg lg:text-3xl font-extrabold text-black scale-200 hover:scale-125 transition-transform duration-300 ease-in-out px-0 flex items-center"
                        >
                            <img
                                alt="GuardianAI"
                                src="lock.png"
                    ...
                    <div className="flex gap-4">
                        ...
                        <Link href="/get-started" className="btn text-black">
                            Information1
                        </Link>
                    </div>
                </div>
